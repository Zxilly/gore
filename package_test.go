...
func TestClassifyPackage(t *testing.T) {
	...
	tests := []struct {
		...
		{"vendor/golang_org/x/text/unicode/norm", "c:/go/src/vendor/golang_org/x/text/unicode/norm", ClassSTD},
		{"vendor/golang_org/x/net/dns/dnsmessage", ".", ClassSTD},
		{"vendor/golang_org/x/text/unicode/bidi", "c:/go/src/vendor/golang_org/x/text/unicode/bidi", ClassSTD},
		{"github.com/go-ole/go-ole", "c:/go/src/github.com/go-ole/go-ole", ClassVendor},
		{"vendor/golang_org/x/text/secure/bidirule", "c:/go/src/vendor/golang_org/x/text/secure/bidirule", ClassSTD},
		{"vendor/golang_org/x/crypto/poly1305", "c:/go/src/vendor/golang_org/x/crypto/poly1305", ClassSTD},
		{"vendor/golang_org/x/crypto/curve25519", "c:/go/src/vendor/golang_org/x/crypto/curve25519", ClassSTD},
		...
		{"vendor/golang_org/x/net/idna", "c:/go/src/vendor/golang_org/x/net/idna", ClassSTD},
		...
		{"vendor/golang_org/x/net/http/httpguts", "c:/go/src/vendor/golang_org/x/net/http/httpguts", ClassSTD},
		{"vendor/golang_org/x/crypto/internal/chacha20", "c:/go/src/vendor/golang_org/x/crypto/internal/chacha20", ClassSTD},
		{"vendor/golang_org/x/crypto/cryptobyte", "c:/go/src/vendor/golang_org/x/crypto/cryptobyte", ClassSTD},
		{"vendor/golang_org/x/crypto/chacha20poly1305", "c:/go/src/vendor/golang_org/x/crypto/chacha20poly1305", ClassSTD},
		{"golang.org/x/sys/windows/registry", "c:/go/src/golang.org/x/sys/windows/registry", ClassVendor},
		{"vendor/golang_org/x/text/transform", ".", ClassSTD},
